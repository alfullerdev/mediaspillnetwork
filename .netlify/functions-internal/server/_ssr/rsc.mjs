...
function getDraftSecret() {
	return "b367ea0c-80d6-43d2-8b89-38cc63377c43";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "b672a7fa-7943-4c0e-9ea3-ba77ae4df5bb";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "b672a7fa-7943-4c0e-9ea3-ba77ae4df5bb") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "b672a7fa-7943-4c0e-9ea3-ba77ae4df5bb",
		rootBoundaryId
	});
}
/**
